...
export default function MusicPlayer({ src }: { src: string }) {
  ...
  return (
    <>
      ...
      <div
        className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-4 py-3 rounded-2xl shadow-lg transition-all duration-700"
        style={{
      ...
      >
        ...
        <div>
          <p className="text-xs font-medium leading-none mb-0.5" style={{ color: "var(--deep-mauve)", fontFamily: "'Cormorant Garamond', serif", fontSize: "0.8rem" }}>
            Our Song
          </p>
          <p className="text-xs leading-none" style={{ color: "var(--dusty-rose)", opacity: 0.7, fontSize: "0.65rem", letterSpacing: "0.05em" }}>
